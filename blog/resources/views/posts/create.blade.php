...
@section('body')
    <div class="flex justify-center">
        ...
        <h2 class="text-xl pb-4">Új bejegyzés</h2>
...
@endif
            <div class="mb-4">
                <input type="text" name="title" id="title" placeholder="Figyelemfelkeltő cím" class="w-full p-4 mb-4 border-2 border-grey-700">
            ...
            <textarea name="body" id="body" cols="30" rows="10" placeholder="Hosszas tartalom" class="w-full p-4 border-2 border-grey-700"></textarea>
